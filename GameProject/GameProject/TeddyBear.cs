    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds > firingDelay)
            {
                ...
                firingDelay = GetRandomFiringDelay();
                Projectile teddyProjectile = new Projectile(ProjectileType.TeddyBear, Game1.GetProjectileSprite(ProjectileType.TeddyBear), drawRectangle.Center.X, drawRectangle.Y+GameConstants.TeddyBearProjectileOffset, GetProjectileYVelocity());
